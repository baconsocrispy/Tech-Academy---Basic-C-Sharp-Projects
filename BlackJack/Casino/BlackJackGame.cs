    ...
    public class BlackJackGame : Game, IWalkAway
    {
        ...
        public override void Play()
        {
            ...
            foreach (Player player in Players)
            {
                while (!player.Stay)
                {
                    ...
                    if (busted)
                    {
                        ...
                        Console.WriteLine("{0} Busted! You lose your balance of {1}. Your balance is now {2}", player.Name, Bets[player], player.Balance);
                        Console.WriteLine("Do you want to play again? If so, type 'y'...");
            ...
            foreach (Player player in Players)
            {
                ...
                if (playerWon == null)
                {
                    Console.WriteLine("Push! No one woins.");
